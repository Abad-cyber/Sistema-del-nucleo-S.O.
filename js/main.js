...
function inicializarBotonesAdicionales() {
  document.getElementById('btnEjecutarSidebar')?.addEventListener('click', () => {
    // El evento se maneja dinámicamente según el módulo activo
  });
}
...
function inicializarNavegacion() {
  ...
  document.getElementById('homeCardCPU')?.addEventListener('click', () => {
    activarModulo('cpu');
  });
  
  document.getElementById('homeCardDisco')?.addEventListener('click', () => {
    activarModulo('disco');
  });
}

function activarModulo(modulo) {
  const navGrupoCPU = document.getElementById('navGrupoCPU');
  const navGrupoDisco = document.getElementById('navGrupoDisco');
  const btnEjecutarSidebar = document.getElementById('btnEjecutarSidebar');
  const textoEjecutar = document.getElementById('textoEjecutar');
